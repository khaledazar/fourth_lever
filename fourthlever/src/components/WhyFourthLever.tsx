        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          >
            <Tile className="h-full flex flex-col justify-between">
              <div>
                <div className="w-[46px] h-[46px] bg-white border border-border-light rounded-xl flex items-center justify-center mb-6">
                  <svg
                    width="22"
                    height="22"
                    viewBox="0 0 24 24"
                ...
                <p className="font-body text-[16px] text-secondary leading-[1.75] mb-8">
            ...
            {differentiators.map((d, i) => (
              ...
              >
                <Tile className="h-full">
                  ...
                  <h3 className="font-heading font-bold text-[15px] text-primary mb-2">
                    {d.title}
                  </h3>
