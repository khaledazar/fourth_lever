...
/* ─────────────────────────────────────────────────────
   Dashboard Terminal — typewriter that starts on load
   ───────────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────────
   Dashboard Counter — counts from 0 to target
   ───────────────────────────────────────────────────── */
...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="hero-dark relative min-h-screen flex flex-col overflow-hidden"
    >
      {/* ── Animated grid ───────────────────────────── */}
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center w-full max-w-[1120px] mx-auto px-5 sm:px-8 lg:px-12 pt-24 pb-12">
        ...
        <motion.p
          ...
          className="font-body text-base sm:text-lg text-white/40 max-w-xl leading-relaxed text-center mb-9"
        >
          We build, deploy, and manage AI systems so you get results — without
          another tool to learn or an engineering team to hire.
        </motion.p>
        ...
        >
          {/* Emerald glow behind dashboard */}
          <div className="dashboard-glow" />

          {/* Dashboard with 3D perspective + mouse parallax */}
          <div
          ...
          >
            ...
            <div className="flex items-center gap-0 px-4 sm:px-5 border-b border-white/[0.06] overflow-x-auto">
              {dashTabs.map((tab, i) => (
                <span
                  key={tab}
                  className={`px-3 sm:px-4 py-2.5 font-mono text-[11px] sm:text-[12px] whitespace-nowrap transition-colors ${
                    i === 0
            ...
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-3 p-4 sm:p-5">
                <div className="flex items-center justify-between mb-3">
                  <span className="font-mono text-[10px] font-semibold uppercase tracking-[0.2em] text-white/25">
                    Active Services
                  </span>
                ...
                <div className="space-y-1.5">
                  {services.map((svc, i) => (
                    <motion.div
                      ...
                      transition={{ duration: 0.35, delay: 1.4 + i * 0.08 }}
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-body text-[12px] sm:text-[13px] text-white/60">
                          {svc.name}
                        </span>
                      </div>
              ...
              {dashMetrics.map((m, i) => (
                <motion.div
                  ...
                  className={`px-4 sm:px-5 py-3.5 ${
                    ...
                    i >= 2
                      ? "border-t border-white/[0.06] md:border-t-0 md:border-l"
                      : ""
                  }`}
                >
                  ...
                  <div className="font-mono text-[9px] text-white/25 uppercase tracking-[0.15em] mt-0.5">
                    {m.label}
                  </div>
                </motion.div>
              ))}
            ...
            <div className="flex items-center justify-between px-4 sm:px-5 py-2 border-t border-white/[0.04] bg-white/[0.01]">
              <span className="font-mono text-[9px] text-white/12">
                fourth-lever v2.4.1
              </span>
              <span className="font-mono text-[9px] text-white/12">
                Last sync: just now
      ...
      >
        ...
        >
          <span className="font-mono text-[9px] text-white/15 uppercase tracking-[0.25em]">
            Scroll
          </span>
